...
class MyApp(QWidget):
    ...
    def AroonStart(self):
        ...
        Aroon(self.df, N)
        with open('Result_Aroon_'+ interval + period +'.csv','w', newline='') as f:
            wr = csv.writer(f)
    ...
    def RSIStart(self):
        ...
        with open('Result_RSI_'+ interval + period +'.csv','w', newline='') as f:
            wr = csv.writer(f)
            wr.writerow(['', 'open time','close', 'Success/Fail', 'Earning Rate (%)'])
    ...
    def Groupbox_Supertrend(self):
        ...
        self.lbl_supertrend_result = QLabel('Done')
    ...
    def SupertrendStart(self):
        ...
        with open('Result_Supertrend_'+ interval + period +'.csv','w', newline='') as f:
            wr = csv.writer(f)
            wr.writerow(['', 'open time','close', 'Success/Fail', 'Earning Rate (%)'])
